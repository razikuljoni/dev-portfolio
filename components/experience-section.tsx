export default function Experience() {
  return (
    // EXPERIENCE Section
    <section id="experience" className="pt-6 pb-2">
      <div
              ...
              >
                <div className="min-h-0 overflow-hidden">
                  <div className="border-t border-border/50 px-3 pt-2 pb-4 transition-opacity duration-150 sm:px-4 opacity-0">
                    <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
                      <li>
                        Building and maintaining Audora (WebRTC recording, media
                        pipelines, S3 multipart uploads) and CoSketch (real-time
                        collaboration, WebSockets).
                      </li>
                      <li>
                        Contributing to product and technical direction as part
                        of the founding team.
                      </li>
                      <li>
                        Developing create-audora-next and NextBlog-Starter under
                        AudoraLabs for the community.
                      </li>
                      <li>
                        Designing scalable architectures and CI/CD for reliable
                        deployments.
                      </li>
                      <li>
              ...
              >
                <div className="min-h-0 overflow-hidden">
                  <div className="border-t border-border/50 px-3 pt-2 pb-4 transition-opacity duration-150 sm:px-4 opacity-0">
                    <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
                      <li>
                        Provided technical support and architecture guidance to
                        6 early-stage startups on system design, deployment
                        strategies, and cloud infrastructure setup through
                        iStart Rajasthan Govt. program.
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        enabling franchise model distribution, with multi-tenant
                        architecture supporting independent businesses and
                      ...
                      <li>
                        ...
                        responsive state management and automated notifications.
                      </li>
                    </ul>
                    <div className="mt-3 flex flex-wrap gap-2">
                      <span className="rounded-md border border-border px-2 py-1 text-xs font-medium text-foreground">
              ...
              >
                <div className="min-h-0 overflow-hidden">
                  <div className="border-t border-border/50 px-3 pt-2 pb-4 transition-opacity duration-150 sm:px-4 opacity-0">
                    <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
                      <li>
                        Implemented Infrastructure as Code using Terraform to
                        standardize cloud resources and reduce configuration
                        drift across AWS environments.
                      </li>
                      <li>
                        Automated CI/CD pipelines with GitHub Actions, reducing
                        deployment time by ~40% and enabling consistent
                        releases.
                      </li>
                      <li>

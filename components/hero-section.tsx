    ...
    <section className="container mx-auto flex max-w-(--content-max-width) flex-col items-start justify-center px-4 pt-10 pb-4 sm:pt-12 sm:pb-6">
      <div className="flex flex-col gap-6">
        <div className="flex flex-row gap-4 sm:items-start sm:gap-6 transition-all duration-600 ease-out translate-y-0 opacity-100">
          ...
          <div className="flex min-h-24 flex-col justify-end sm:min-h-28">
            <div className="flex items-center gap-2">
              <h1 className="text-4xl font-bold tracking-tight">Narsi Bhati</h1>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                className="mt-1 h-6 w-6 shrink-0 text-[#1d9bf0] select-none dark:text-[#1d9bf0]"
                role="img"
                aria-label="Verified"
              >
                <path
        ...
        <p className="max-w-[650px] text-lg text-muted-foreground transition-all duration-600 ease-out delay-150 translate-y-0 opacity-100">
          Building robust web apps and cloud solutions. Focused on clean
          architecture, DevOps, and user experience.
        </p>
              ...
              <div className="relative h-5 w-5 overflow-hidden">
                ...
                >
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-mail h-5 w-5 shrink-0"
                    aria-hidden="true"
                  >
          ...
          >
            ...
            >
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-menu h-4 w-4 shrink-0"
                aria-hidden="true"
              >
                <path d="M4 5h16"></path>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            >
              <a
                target="_blank"
                rel="noopener noreferrer"
                className="group inline-flex items-center justify-center rounded-md p-2 text-white transition-all duration-200 hover:scale-110 hover:shadow-md"
                aria-label="React - Visit website"
                data-state="closed"
                data-slot="tooltip-trigger"
                href="https://react.dev/"
                style={{ backgroundColor: "rgb(91, 154, 169)" }}
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
            ...
            >
              <a
                ...
                rel="noopener noreferrer"
                className="group inline-flex items-center justify-center rounded-md p-2 text-white transition-all duration-200 hover:scale-110 hover:shadow-md"
                aria-label="Next.js - Visit website"
                data-state="closed"
                data-slot="tooltip-trigger"
            ...
            >
              <a
                ...
                rel="noopener noreferrer"
                className="group inline-flex items-center justify-center rounded-md p-2 text-white transition-all duration-200 hover:scale-110 hover:shadow-md"
                aria-label="TypeScript - Visit website"
                data-state="closed"
                data-slot="tooltip-trigger"
                href="https://www.typescriptlang.org/"
                style={{ backgroundColor: "rgb(74, 122, 168)" }}
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
            ...
            >
              <a
                ...
                rel="noopener noreferrer"
                className="group inline-flex items-center justify-center rounded-md p-2 text-white transition-all duration-200 hover:scale-110 hover:shadow-md"
                aria-label="Node.js - Visit website"
                data-state="closed"
                data-slot="tooltip-trigger"
                href="https://nodejs.org/"
                style={{ backgroundColor: "rgb(90, 138, 90)" }}
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
            ...
            >
              <a
                ...
                rel="noopener noreferrer"
                className="group inline-flex items-center justify-center rounded-md p-2 text-white transition-all duration-200 hover:scale-110 hover:shadow-md"
                aria-label="PostgreSQL - Visit website"
                data-state="closed"
                data-slot="tooltip-trigger"
                href="https://www.postgresql.org/"
                style={{ backgroundColor: "rgb(74, 106, 154)" }}
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
            ...
            >
              <a
                ...
                rel="noopener noreferrer"
                className="group inline-flex items-center justify-center rounded-md p-2 text-white transition-all duration-200 hover:scale-110 hover:shadow-md"
                aria-label="Rust - Visit website"
                data-state="closed"
                data-slot="tooltip-trigger"
                href="https://www.rust-lang.org/"
                style={{ backgroundColor: "rgb(168, 106, 90)" }}
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
            ...
            >
              <a
                ...
                rel="noopener noreferrer"
                className="group inline-flex items-center justify-center rounded-md p-2 text-white transition-all duration-200 hover:scale-110 hover:shadow-md"
                aria-label="Solana - Visit website"
                data-state="closed"
                data-slot="tooltip-trigger"
                href="https://solana.com/"
                style={{ backgroundColor: "rgb(122, 90, 154)" }}
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
            ...
            >
              <a
                ...
                rel="noopener noreferrer"
                className="group inline-flex items-center justify-center rounded-md p-2 text-white transition-all duration-200 hover:scale-110 hover:shadow-md"
                aria-label="AWS - Visit website"
                data-state="closed"
                data-slot="tooltip-trigger"
                href="https://aws.amazon.com/"
                style={{ backgroundColor: "rgb(154, 122, 74)" }}
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
            ...
            >
              <a
                ...
                rel="noopener noreferrer"
                className="group inline-flex items-center justify-center rounded-md p-2 text-white transition-all duration-200 hover:scale-110 hover:shadow-md"
                aria-label="Docker - Visit website"
                data-state="closed"
                data-slot="tooltip-trigger"
                href="https://www.docker.com/"
                style={{ backgroundColor: "rgb(74, 122, 154)" }}
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
            ...
            >
              <a
                ...
                rel="noopener noreferrer"
                className="group inline-flex items-center justify-center rounded-md p-2 text-white transition-all duration-200 hover:scale-110 hover:shadow-md"
                aria-label="Kubernetes - Visit website"
                data-state="closed"
                data-slot="tooltip-trigger"
            ...
            >
              <a
                ...
                rel="noopener noreferrer"
                className="group inline-flex items-center justify-center rounded-md p-2 text-white transition-all duration-200 hover:scale-110 hover:shadow-md"
                aria-label="GitHub Actions - Visit website"
                data-state="closed"
                data-slot="tooltip-trigger"
                href="https://github.com/features/actions"
                style={{ backgroundColor: "rgb(90, 122, 154)" }}
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
            ...
            >
              <a
                ...
                rel="noopener noreferrer"
                className="group inline-flex items-center justify-center rounded-md p-2 text-white transition-all duration-200 hover:scale-110 hover:shadow-md"
                aria-label="Terraform - Visit website"
                data-state="closed"
                data-slot="tooltip-trigger"
                href="https://www.terraform.io/"
                style={{ backgroundColor: "rgb(106, 90, 138)" }}
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path d="M1.44 0v7.575l6.561 3.79V3.787zm21.12 4.227l-6.561 3.791v7.574l6.56-3.787zM8.72 4.23v7.575l6.561 3.787V8.018zm0 8.405v7.575L15.28 24v-7.578z"></path>
                </svg>
              </a>
            </div>
          </div>

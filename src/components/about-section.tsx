                    ...
                    <div className="grid gap-6 md:grid-cols-[1.1fr_0.9fr]">
                        ...
                        >
                            <p className="text-base text-muted-foreground">
                                ...
                                experiences. I care deeply about clean architecture, accessibility,
                                performance, and maintainable engineering standards.
                            </p>
                        </div>
                        <div className="grid gap-3">
                            ...
                            <div className="rounded-lg border border-border/50 p-4 transition-colors hover:border-border">
                                ...
                                <p className="mt-2 text-sm text-muted-foreground">
                                    Design reusable UI foundations and implementation patterns that
                                    keep products consistent while accelerating team delivery.
                                </p>
                            </div>
                            <div className="rounded-lg border border-border/50 p-4 transition-colors hover:border-border">
                                <h3 className="text-sm font-semibold uppercase tracking-wider">

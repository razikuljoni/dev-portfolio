                                        ...
                                        <Accordion.Content>
                                            <div className="border-t border-border/50 px-3 pt-2 pb-4 sm:px-4">
                                                <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
                                                    ...
                                                    <li>
                                                        Built inventory tracking and product
                                                        management platforms with dynamic data
                                                        handling.
                                                    </li>
                                                    <li>
                                                        Created field-work assignment interfaces
                                                        with real-time status updates and reporting
                                                        features.
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        Managed complex application state using
                                                        Redux Toolkit and RTK Query.
                                                    </li>
                                                    <li>
                                                        Deployed applications using Vercel and
                                                        managed basic version control and CI/CD
                                                        using Git/GitHub.
                                                    </li>
                                                </ul>
